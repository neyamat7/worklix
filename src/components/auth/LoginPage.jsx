          ...
          <div className="max-w-lg text-center">
            <div className="relative mb-8">
              <Lottie
                ...
                loop
                autoplay
                className="relative w-96 h-96 mx-auto rounded-3xl  backdrop-blur-sm"
              />
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8">
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  type="button"
                  className="w-full flex items-center justify-center px-4 py-3 border border-gray-300/50 dark:border-gray-600/50 rounded-xl shadow-sm bg-white/50 hover:bg-gray-100 dark:bg-gray-700/50 backdrop-blur-sm text-sm font-medium text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 transition-all duration-200"
                >
